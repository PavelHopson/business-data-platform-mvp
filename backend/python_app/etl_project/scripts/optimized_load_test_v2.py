...
def run_optimized_load_test(inn_file: str) -> Dict:
    logger.info("Starting optimized ETL load test simulation v2")
    ...
    try:
        ...
        report = {
            ...
            'test_type': 'optimized_load_test_v2',
        ...
        print("=" * 60)
        print("📊 ОТЧЕТ ПО НАГРУЗОЧНОМУ ТЕСТИРОВАНИЮ ETL V2")
        print("=" * 60)
        ...
        with open('logs/performance_report_v2.json', 'w', encoding='utf-8') as f:
            json.dump(report, f, ensure_ascii=False, indent=2)
        
        print(f"📁 Отчет сохранен: logs/performance_report_v2.json")
        print("=" * 60)
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python optimized_load_test_v2.py <inn_file>")
        sys.exit(1)
